...
const props = defineProps({
  contentManager: { type: Object, default: () => ({}) },
...
const defaultVerified =
  props.mode === "edit"
    ? !!props.contentManager.email_verified_at
    : true;
...
const handleSubmit = () => {
  if (props.mode === "edit") {
    form.put(route("admin.content-managers.update", props.contentManager.id));
  } else {
    form.post(route("admin.content-managers.store"));
  }
};
</script>
