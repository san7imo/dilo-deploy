...
const pendingContentManagerId = ref(null);

const openDeleteModal = (id) => {
  pendingContentManagerId.value = id;
...
const closeDeleteModal = () => {
  ...
  pendingContentManagerId.value = null;
};

const handleDelete = () => {
  if (!pendingContentManagerId.value || deleteProcessing.value) return;

  deleteProcessing.value = true;
  router.delete(route("admin.content-managers.destroy", pendingContentManagerId.value), {
    onFinish: () => {
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-3 px-4 text-right">
                <RowActionMenu label="Acciones de gestor">
                  <Link
