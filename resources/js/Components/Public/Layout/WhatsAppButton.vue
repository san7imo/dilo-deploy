...
<template>
  <a :href="href" target="_blank" rel="noopener noreferrer" class="group fixed z-50 bottom-10 right-8 inline-flex items-center justify-center
           transition hover:scale-105 active:scale-95
           focus:outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/30" aria-label="Escribir por WhatsApp"
    title="Escribir por WhatsApp">
    <!-- WhatsApp logo -->
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
      class="w-12 h-12 fill-[#25D366] hover:opacity-80 transition">
      <path
    ...
    <!-- Tooltip sencillo -->
    <span class="pointer-events-none absolute right-16 whitespace-nowrap rounded-lg bg-black/85 px-3 py-1.5
