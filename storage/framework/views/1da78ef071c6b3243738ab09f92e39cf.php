...
<body>
    <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
        Restablece tu contrasena en <?php echo e($appName); ?> de forma segura.
    </div>
                ...
                <table role="presentation" width="100%" style="max-width:620px; background-color:#ffffff; border:1px solid #e6e9ee; border-radius:12px; overflow:hidden;">
                    <tr>
                        <td style="background:#111827; padding:24px 32px; font-family:'Trebuchet MS', 'Segoe UI', Arial, sans-serif; color:#ffffff;">
                            <div style="font-size:18px; letter-spacing:2px; text-transform:uppercase;"><?php echo e($appName); ?></div>
                    ...
                    <tr>
                        <td style="padding:32px; font-family:'Trebuchet MS', 'Segoe UI', Arial, sans-serif; color:#1f2933;">
                            ...
                            <p style="margin:0 0 24px; text-align:center;">
                                <a href="<?php echo e($actionUrl); ?>" style="background:#2563eb; color:#ffffff; padding:12px 24px; text-decoration:none; border-radius:6px; display:inline-block; font-weight:600;">
                    ...
                    <tr>
                        <td style="padding:20px 32px; background:#f8fafc; font-family:'Trebuchet MS', 'Segoe UI', Arial, sans-serif; color:#7b8794; font-size:12px; line-height:1.6;">
                            <div>Necesitas ayuda? Responde a este correo o escribenos a <?php echo e($supportEmail); ?>.</div>
                            <div style="margin-top:8px;"><?php echo e($appName); ?> - <?php echo e($appUrl); ?></div>
                        </td>
                    </tr>
                </table>
            </td>
...
<?php /**PATH /home/san7imo/Escritorio/Proyectos/dilo-deploy/resources/views/emails/password-reset.blade.php ENDPATH**/ ?>